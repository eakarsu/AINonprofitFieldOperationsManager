...
export default function GapShiftsWithoutShiftPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-shifts-without-shift/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Shifts without '/shift</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Shifts without /shift-optimization (balance volunteer load and satisfaction)</p>
