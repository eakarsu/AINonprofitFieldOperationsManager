...
export default function GapProgramsWithoutProgramPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-programs-without-program/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Programs without '/program</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Programs without /program-risk-assessment (flag underperforming initiatives early)</p>
